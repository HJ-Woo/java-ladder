# 사다리 게임
> ✔ 과정 전체 회고
> - 스트림과 람다를 적극 활용할 수 있게 되었다.
> - 네이밍은 최대한 의미가 담기게끔 구성해야한다.
> - Generics을 활용하여 새로운 구조를 구현해내보았다.
> - Stream.foreach()와 Collection.foreach()의 차이에 대해 학습하였다. [참고](https://www.baeldung.com/java-collection-stream-foreach)
> - LSP와 OCP를 만족시키는 확장 구조를 구성하도록 리팩토링하였다. (클래스 상속보다는 조합으로 해결)
> - 인터페이스를 어떤 상황에서 추출해야할지 고려 [참고](https://www.slipp.net/questions/55)
...
- [X] 결과를 보고싶은 사람을 입력받고, 결과를 출력한다. 이 과정을 all을 입력할때까지 반복한다.
- [X] 결과를 보고싶은 사람과 전체의 결과를 확인할 수 있다.
</details>
